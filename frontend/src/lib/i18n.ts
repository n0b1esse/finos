...
const STORAGE_KEY = "finos:language";
// Previous brand key — read once as fallback, then migrated to the new key.
const LEGACY_STORAGE_KEY = "aurum:language";
...
const ru = {
  ...
  "auth.noAuthModalBody": "Этот экземпляр FinOS не защищён паролем — все данные доступны любому, кто до него достучится. Задайте FINOS_BASIC_AUTH_USER и FINOS_BASIC_AUTH_PASSWORD в .env, чтобы включить вход.",
  ...
  "netWorth.liabilitiesTitle": "Долги",
  "netWorth.monthlyPaymentsTotal": "платежи {{amount}}/мес",
  "netWorth.noLiabilities": "Долгов нет — капитал чистый",
  ...
  "crypto.search.noApiKey": "Не настроен ключ CoinGecko API — задайте FINOS_COINGECKO_API_KEY в .env (бесплатный ключ на coingecko.com/en/api/pricing).",
  ...
  "backup.invalidFile": "Файл повреждён или не является JSON-бэкапом FinOS.",
  ...
  "settings.version": "FinOS v{{version}}",
  ...
  "credit.empty": "Кредитов пока нет. Добавьте первый — ипотеку, автокредит или карту.",
  "credit.totalDebt": "долгов на {{amount}}",
  "credit.remaining": "осталось {{amount}}",
  "credit.paidOff": "Выплачен!",
  "credit.payLabel": "Внести платёж",
  "credit.confirmDelete": "Удалить кредит «{{name}}»?\n\nЕго платежи тоже будут удалены.",
  "credit.form.newTitle": "Новый кредит",
  "credit.form.editTitle": "Изменить кредит",
  "credit.form.nameLabel": "Название",
  "credit.form.namePlaceholder": "Ипотека, автокредит, карта…",
  "credit.form.typeLabel": "Тип",
  "credit.form.totalLabel": "Сумма долга",
  "credit.form.rateLabel": "Ставка, % годовых",
  "credit.form.monthlyLabel": "Платёж в месяц",
  "credit.form.startLabel": "Дата начала (необязательно)",
  "credit.form.endLabel": "Дата окончания (необязательно)",
  "credit.form.saveError": "Не удалось сохранить кредит. Проверьте данные и попробуйте снова.",
  "credit.payment.title": "Платёж: {{name}}",
  "credit.payment.amountLabel": "Сумма",
  "credit.payment.amountPlaceholder": "Например, 500",
  "credit.payment.dateLabel": "Дата",
  "credit.payment.noteLabel": "Заметка (необязательно)",
  "credit.payment.hint": "Платёж уменьшает остаток долга. Переплата просто закроет кредит досрочно.",
  "credit.payment.saveError": "Не удалось сохранить платёж. Проверьте данные и попробуйте снова.",
  "credit.type.consumer": "Потребительский",
  "credit.type.mortgage": "Ипотека",
  "credit.type.auto": "Автокредит",
  "credit.type.credit_card": "Кредитная карта",
  "credit.type.other": "Другое",
...
const en: Record<keyof typeof ru, string> = {
  ...
  "auth.noAuthModalBody": "This FinOS instance has no password protection — all data is accessible to anyone who can reach it. Set FINOS_BASIC_AUTH_USER and FINOS_BASIC_AUTH_PASSWORD in .env to enable login.",
  ...
  "netWorth.liabilitiesTitle": "Debts",
  "netWorth.monthlyPaymentsTotal": "payments {{amount}}/mo",
  "netWorth.noLiabilities": "No debts — capital is clean",
  ...
  "crypto.search.noApiKey": "CoinGecko API key not configured — set FINOS_COINGECKO_API_KEY in .env (free key at coingecko.com/en/api/pricing).",
  ...
  "backup.invalidFile": "The file is corrupted or is not a FinOS JSON backup.",
  "backup.confirmImport":
  ...
  "credit.empty": "No credits yet. Add your first one — a mortgage, car loan, or card.",
  "credit.totalDebt": "{{amount}} owed",
  "credit.remaining": "{{amount}} left",
  "credit.paidOff": "Paid off!",
  "credit.payLabel": "Make a payment",
  "credit.confirmDelete": "Delete the credit “{{name}}”?\n\nIts payments will be deleted too.",
  "credit.form.newTitle": "New credit",
  "credit.form.editTitle": "Edit credit",
  "credit.form.nameLabel": "Name",
  "credit.form.namePlaceholder": "Mortgage, car loan, card…",
  "credit.form.typeLabel": "Type",
  "credit.form.totalLabel": "Debt amount",
  "credit.form.rateLabel": "Annual rate, %",
  "credit.form.monthlyLabel": "Monthly payment",
  "credit.form.startLabel": "Start date (optional)",
  "credit.form.endLabel": "End date (optional)",
  "credit.form.saveError": "Failed to save the credit. Check the data and try again.",
  "credit.payment.title": "Payment: {{name}}",
  "credit.payment.amountLabel": "Amount",
  "credit.payment.amountPlaceholder": "e.g. 500",
  "credit.payment.dateLabel": "Date",
  "credit.payment.noteLabel": "Note (optional)",
  "credit.payment.hint": "A payment shrinks the outstanding balance. Overpaying simply closes the credit early.",
  "credit.payment.saveError": "Failed to save the payment. Check the data and try again.",
  "credit.type.consumer": "Consumer",
  "credit.type.mortgage": "Mortgage",
  "credit.type.auto": "Car loan",
  "credit.type.credit_card": "Credit card",
  "credit.type.other": "Other",
